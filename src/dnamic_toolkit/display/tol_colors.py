...
def tol_cset(colorset=None):
    ...
    namelist = ('bright', 'high-contrast', 'vibrant', 'muted', 'medium-contrast', 'light', 'pale')
    if colorset is None:
        return namelist
    ...
    if colorset == 'pale':
        cset = namedtuple('paleset',
                    'blue cyan green yellow red grey')
        return cset('#BBCCEE', '#CCEEFF', '#CCDDAA', '#EEEEBB', '#FFCCCC',
                    '#DDDDDD')
